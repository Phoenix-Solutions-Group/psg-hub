...
Status: active release guardrail after PSG-2605 production miss on 2026-08-03.
...
- Create child tasks for QA, operator actions, Nick approvals, or production-review asks instead of burying those asks in comments.
