...
| Operational dashboard                                               | Preview deployed; authenticated product QA pending | `/dashboard/collision-intelligence` includes repair, insurer, ZIP, vehicle, quality, 13-week period comparisons, KDOT crash, weather, baseline, recent SPC signals, four-week forecasts, evidence-bound planning guidance, and a live scorecard; production build and unauthenticated preview checks pass | Run authenticated desktop/mobile preview QA, complete product approval, deploy, and smoke test                                                           |
