...
| ZIP-level weather and market alerts                                 | Review queue backtested; notifications remain off          | Service-only `v_collision_zip_alert_candidates`; atomic three-day SPC refresh; historical proxy shows 4.89% follow-through versus 4.39% control and does not support broad notifications                                                                                                                                                            | Deploy/smoke-test the cron; approve owner and lifecycle; validate exact 1–4 week live SPC outcomes against a pre-registered business threshold before authorizing notifications |
