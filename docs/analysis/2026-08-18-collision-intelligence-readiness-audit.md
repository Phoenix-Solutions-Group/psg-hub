...
| ZIP-level weather and market alerts                                 | Review lifecycle staged; notifications remain off           | Service-only `v_collision_zip_alert_candidates`; atomic three-day SPC refresh; historical proxy shows 4.89% follow-through versus 4.39% control; staged cases require owner/manager acknowledgement and a governed repair-demand outcome                                                                                                                | Apply the lifecycle migration, name the organization-level notification owner, and validate exact 1–4 week live outcomes against a pre-registered business threshold before authorizing notifications |
