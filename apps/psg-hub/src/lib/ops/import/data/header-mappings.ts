// PSG-132 — Master source-header -> canonical-38 alias map.
//
// Ported verbatim from `Phoenix-Solutions-Group/import` @ main `a11133d`
// (`src/lib/mappings/header-mappings.ts`) ahead of the PSG-50 decommission.
// NOTE: there is no `MASTER_header_mappings.json` in the source — the master map
// IS this inline const. These aliases resolve raw estimating-system export
// headers onto the **canonical-38** vocabulary (`OwnerFName`, `VehicleMake`, …),
// which is distinct from the parent `../fields.ts` aliases (RO/Estimate hub
// vocabulary). It feeds the canonical-38 / FileMaker import direction, bridged by
// ../filemaker/bridge.ts — do NOT merge these into ../fields.ts (different keys).
