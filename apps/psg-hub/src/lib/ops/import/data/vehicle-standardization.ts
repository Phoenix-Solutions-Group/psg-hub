// PSG-132 — Vehicle make/model standardization.
//
// Ported verbatim from `Phoenix-Solutions-Group/import` @ main `a11133d`
// (`src/lib/processing/vehicle-standardization.ts`) ahead of the PSG-50
// decommission. Expands BMS make abbreviations, strips trim/drivetrain/body
// tokens to the base model, normalizes casing, and validates the model year —
// all against the public `CAR_DATA` set (./car-data). Operates on canonical-38
// rows (./types `Row`).
