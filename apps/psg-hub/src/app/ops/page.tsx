...
const MODULES: {
  ...
  href: string;
  note: string;
  // Security-profile management remains superadmin-only at the route/API layer;
  // the admin landing also includes user access and audit surfaces for the
  ...
  { fn: "manage_bsm_content_approvals", label: "Content Approvals", href: "/ops/bsm-content-approvals", note: "Create review workspaces, upload customer review files, and track approval status" },
