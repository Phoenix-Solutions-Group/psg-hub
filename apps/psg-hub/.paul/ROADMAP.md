...
**None active.** v0.3.5 Presence + Sentiment ✅ BUILD-CLOSED 2026-06-18 (2/2 phases; see Completed Milestones + `.paul/milestones/v0.3.5-ROADMAP.md`). Prod activation is the G1 tail tracked in [PSG-23](/PSG/issues/PSG-23) (Phase-14 migrate + `vercel --prod`; GBP external Gate A/B). **Next: create v0.4 Invoicing + Payments** (`/paul:discuss-milestone` → `/paul:milestone`).
...
<details>
<summary>v0.3.5 Presence + Sentiment — 2026-06-18 build-close (2 phases, 9 plans; activation-pending G1)</summary>

| Phase | Name | Plans | Completed |
|-------|------|-------|-----------|
| 13 | GBP presence foundation + insights | 6/6 | 2026-06-16 |
| 14 | Reviews + sentiment | 3/3 | 2026-06-17 |

Build closed 2026-06-18; prod activation = the G1 tail in [PSG-23](/PSG/issues/PSG-23). Archive: `.paul/milestones/v0.3.5-ROADMAP.md`.
</details>
