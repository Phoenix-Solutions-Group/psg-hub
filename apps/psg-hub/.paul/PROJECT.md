...
### Active (In Progress)
**v0.3.5 Presence + Sentiment — 🚧 BUILD COMPLETE (2 of 2 phases ✅), milestone close pending. Phase 13 ✅ COMPLETE 2026-06-16 + Phase 14 ✅ COMPLETE 2026-06-17, both ACTIVATION-PENDING. Next: `/paul:complete-milestone` v0.3.5 (or `/paul:plan` the Phase-14 prod-activation gate batch first).**
- [ ] Phase-14 prod-activation gate batch (shared with Phase 13's pending tail): Gate A GBP API 300 QPM + Gate B business.manage verification + Wallace re-consent + the 7-day token pass-gate + live v4 LIST/WRITE smokes + the gateway-Haiku sentiment smoke.
