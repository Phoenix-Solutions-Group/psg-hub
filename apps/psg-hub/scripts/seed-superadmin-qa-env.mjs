  ...
  return [
    {
      ...
      raw: {
        ...shared.raw,
        due_date: "2026-08-29T23:59:59.000Z",
        subtotal: 120000,
        tax: 5000,
        total: 125000,
        balance_due: 125000,
        lines: [
          { id: "riv-1003-creative", description: "August campaign creative", quantity: 1, unit_amount: 75000, amount: 75000 },
          { id: "riv-1003-media", description: "Local advertising management", quantity: 1, unit_amount: 45000, amount: 45000 },
        ],
      },
    ...
    },
    {
      ...
      raw: {
        ...shared.raw,
        due_date: "2026-07-29T23:59:59.000Z",
        subtotal: 250000,
        tax: 0,
        total: 250000,
        balance_due: 0,
        lines: [
          { id: "riv-1002-retainer", description: "July growth marketing program", quantity: 1, unit_amount: 200000, amount: 200000 },
          { id: "riv-1002-reporting", description: "Campaign reporting and optimization", quantity: 1, unit_amount: 50000, amount: 50000 },
        ],
      },
    ...
    },
    {
      ...
      raw: {
        ...shared.raw,
        due_date: "2026-06-29T23:59:59.000Z",
        subtotal: 75000,
        tax: 0,
        total: 75000,
        balance_due: 0,
        lines: [
          { id: "riv-1001-setup", description: "Campaign setup", quantity: 1, unit_amount: 75000, amount: 75000 },
        ],
      },
